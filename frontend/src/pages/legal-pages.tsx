    ...
    <main className="min-h-screen bg-[#f5f0e6] text-[#202635]">
      ...
      <section className="relative h-[400px] overflow-hidden md:h-[430px]">
        ...
        <img
          ...
          alt="Dubai waterfront skyline at dusk"
          loading="eager"
        ...
        <div className="relative z-10 flex h-full items-center px-5 md:px-10">
          <div className="mx-auto w-full max-w-[1280px] pt-8 md:pt-10">

            <p className="eyebrow text-[#d9825f]">
              KNC Horizon Realtor
            </p>

            <h1 className="page-title mt-5 max-w-4xl text-white">
              Privacy Policy
            </h1>
      ...
      {/* =====================================================
          PRIVACY CONTENT
      ====================================================== */}
      <section className="border-t border-[#202635]/10 px-5 py-20 md:px-10 md:py-28">
