...
//           alt="Dubai property and skyline"
//           className="absolute inset-0 h-full w-full object-cover"
//         />

//         <div className="absolute inset-0 bg-[#111827]/65" />

//         <div className="relative z-10 flex min-h-[520px] items-end px-5 pb-16 md:px-10 md:pb-20">
//           <div className="mx-auto w-full max-w-[1200px]">
//             <p className="eyebrow text-[#d9825f]">
//               Legal
//             </p>

//             <h1 className="display mt-6 max-w-4xl text-5xl leading-[0.95] text-white md:text-7xl">
//               Privacy Policy
//             </h1>

//             <p className="mt-8 max-w-2xl text-sm leading-7 text-white/70">
//               This Privacy Policy explains how KNC Horizon Realtor may
//               collect, use, store and protect information submitted through
//               this website and related enquiry channels.
//             </p>
...
//           PRIVACY CONTENT
//       ====================================================== */}
//       <section className="border-t border-[#202635]/10 px-5 py-16 md:px-10 md:py-24">
...
//             <ul className="mt-5 list-disc space-y-2 pl-6 text-sm leading-7 text-[#202635]/65">
//               <li>Your name and contact details.</li>
//               <li>Email address and telephone number.</li>
//               <li>Property preferences and requirements.</li>
//               <li>Budget or investment information that you choose to provide.</li>
//               <li>Details contained in your enquiry or message.</li>
//               <li>Information you voluntarily provide through forms or communication channels.</li>
//               <li>Technical information such as browser, device and website usage data where applicable.</li>
//             </ul>
//           </div>
...
//               <li>Arranging communication or follow-up requested by you.</li>
...
//             <p className="mt-8 max-w-2xl text-sm leading-7 text-white/70">
//               Please read these terms carefully before using the KNC Horizon
//               Realtor website or relying on property information published
//               through it.
//             </p>
...
//               details before making a property or investment decision.
//             </p>
//           </div>
...
//               specification will remain accurate or current at all times.
//             </p>
//           </div>
...
//             <div className="mt-6 rounded-sm border border-[#202635]/10 bg-white/40 p-6">
//               <p className="text-sm leading-7 text-[#202635]/65">
  ...
  return (
    <main className="min-h-screen bg-[#f5f0e6] text-[#202635]">
      ...
      {/* =====================================================
          HERO
      ====================================================== */}
      <section className="relative h-[400px] overflow-hidden md:h-[430px]">

        <img
          src="/images/legal-hero.jpg"
          alt="Dubai skyline and luxury real estate"
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#111827]/55 via-[#111827]/20 to-transparent" />

        <div className="relative z-10 flex h-full items-center px-5 md:px-10">
          <div className="mx-auto w-full max-w-[1200px] pt-8 md:pt-10">

            <p className="eyebrow text-[#d9825f]">
              KNC Horizon Realtor
            </p>

            <h1 className="display mt-5 max-w-4xl text-5xl leading-[0.92] text-white sm:text-6xl md:text-7xl">
              Privacy Policy
            </h1>

            <p className="mt-6 max-w-2xl text-sm leading-7 text-white/80 md:text-[15px]">
              How KNC Horizon Realtor handles information shared through
              our website, property enquiries and communication channels.
            </p>
      ...
      {/* =====================================================
          PRIVACY CONTENT
      ====================================================== */}
      <section className="border-t border-[#202635]/10 px-5 py-12 md:px-10 md:py-16 lg:py-20">

        <div className="mx-auto max-w-[1000px] space-y-12">

          {/* 1 */}
          <div>
            <h2 className="font-serif text-3xl text-[#202635]">
              About this Privacy Policy
            </h2>
      ...
      <section className="relative h-[400px] overflow-hidden md:h-[430px]">
        ...
        <div className="relative z-10 flex h-full items-center px-5 md:px-10">
          <div className="mx-auto w-full max-w-[1200px] pt-8 md:pt-10">
            ...
            <p className="mt-6 max-w-2xl text-sm leading-7 text-white/80 md:text-[15px]">
              Important information about using the KNC Horizon Realtor
              website and the property information published through it.
            </p>
