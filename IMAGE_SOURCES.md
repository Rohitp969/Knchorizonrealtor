...
- **Stored locally** in `frontend/public/images/`. No image is hotlinked from another website.
...
- **Representative photos.** Some listings and pages use a real photo of a comparable place in Dubai, because no free-licence photo of that exact community exists. The alt text for these names only what is actually shown:
  ...
  - Bay by Cavalli shows Port Rashid, next to Dubai Maritime City. Bay Grove shows Dubai Islands from space.
...
|---|---|---|---|---|---|
| `address-sky-view-night.jpg` | Listing: The Address Sky View (Downtown Dubai) | Address Sky View tower in Downtown Dubai lit up at night, with the EMAAR name on its crown | [Unsplash](https://unsplash.com/photos/modern-skyscraper-illuminated-at-night-with-unique-architecture-dt-T0vW-o5U) | Unsplash License | Vishnu Kalanad |
| `business-bay-towers-aerial.jpg` | Listing: Canal Duplex (Business Bay) | Cluster of Business Bay residential high-rises on a clear day, seen from high above, Dubai | [Unsplash](https://unsplash.com/photos/an-aerial-view-of-a-city-with-tall-buildings-1FuwIHTJL0A) | Unsplash License | Nelemson Guevarra |
| `business-bay-canal-day.jpg` | Listing: Canal House (Business Bay) | Business Bay towers along the canal on a clear day, seen from high above, Dubai | [Unsplash](https://unsplash.com/photos/an-aerial-view-of-a-city-with-tall-buildings-cxtmm36ItkQ) | Unsplash License | Nelemson Guevarra |
| `dubai-water-canal-night.jpg` | Listing: Canal Studio (Business Bay) | Dubai Water Canal at night, lit promenades on both banks and towers along the skyline | [Unsplash](https://unsplash.com/photos/lighted-buildings-at-night-52kHTpGahi8) | Unsplash License | Pranav Madhu |
...
| `dubai-creek-harbour-towers.jpg` | Listing: Creekside Loft (Dubai Creek Harbour) | Residential towers at Dubai Creek Harbour in late-afternoon sun, with palm trees below | [Unsplash](https://unsplash.com/photos/cars-parked-near-high-rise-buildings-during-daytime-onP3aM_3tuA) | Unsplash License | Aadil Sabeer |
...
| `jvc-circle-aerial.jpg` | Listing: Circle Gardens (JVC) | Aerial view at dusk of a landscaped circle and apartment blocks in Jumeirah Village Circle, Dubai | [Unsplash](https://unsplash.com/photos/an-aerial-view-of-a-city-with-a-circular-building-Djln5-h7r0I) | Unsplash License | Alim |
| `downtown-night-aerial.jpg` | Listing: City Light Residence (Downtown Dubai); gallery | Downtown Dubai and Sheikh Zayed Road lit up at night, seen from above | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Downtown,_Dubai_(36714617205).jpg) | CC0 (public domain dedication) | bulletrain743 (via Pixabay) |
| `dubai-marina-dusk.jpg` | Listing: Marina Sunline (Dubai Marina); gallery | Dubai Marina towers and the marina canal at dusk | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Dubai_Marina_27.12.2024.jpg) | CC0 (public domain dedication) | Maaroo24 |
| `dubai-marina-promenade.jpg` | Listing: The Meridian Residence (Dubai Marina); gallery | The Dubai Marina promenade curving past the towers in daylight | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Dubai_Marina_5.jpg) | CC0 (public domain dedication) | EditQ |
| `jlt-lake-towers.jpg` | Listing: Lake Level Office (JLT) | Jumeirah Lake Towers high-rises around a JLT lake, seen from the lakeside walk | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:JLT_Lake_from_first_level.jpg) | CC0 (public domain dedication) | Yourusernamewillbepublic2 |
...
| `hero-dubai-skyline.jpg` | Community: Business Bay; gallery | Business Bay towers and the Burj Khalifa at night, reflected in still water | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Dubai_skyline_unsplash.jpg) | CC0 (public domain dedication) | Robert Bock |
...
3. **Save it in `frontend/public/images/` with a descriptive file name.** Do not link to an image hosted on another site.
